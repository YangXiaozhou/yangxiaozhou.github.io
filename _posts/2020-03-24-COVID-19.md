...
- **United States**
    - The increase of new cases continues to slow down [(10%)](#Percentage Change). The trend is largely credible even as many states still face limited supply of testing kits. The US has conducted more than 1.4 million tests over the past ten days, or on average, [140,000 per day](#US Testing Numbers), up from 80,000 per day just one week ago. As the number of tests pending result levels off, it might indicate that, while [more tests are being carried out](https://www.politico.com/interactives/2020/coronavirus-testing-by-state-chart-of-new-cases/), labs are also processing these tests at a faster rate.  
- **Europe**
    + The containment efforts are taking effect as the increase of cases has significantly slowed down, with Italy, the slowest, at 3%, and UK, the fastest, at 10%. 
