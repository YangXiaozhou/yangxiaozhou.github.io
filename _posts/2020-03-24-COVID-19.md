...
I update the current COVID-19 situation in the US, Europe, and Asia, tracking both the outbreak and any emerging signals of containment. Latest update: {{ site.time | date: '%B %d, %Y' }}
