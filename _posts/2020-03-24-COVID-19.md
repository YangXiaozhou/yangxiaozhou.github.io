...
## 1. Prognosis
- **Asia**
    + Singapore's dormitory clusters and local unlinked cases continue to drive up the total number (14% increasing rate). This is expected considering the delay between infection and test confirmation. The government has also stepped up social distancing measures, particularly in the enforcement front. Warnings, fines, and the revoking of passes are as active as the people exercising in public parks on the past Sunday morning. 
...
When should the economy be allowed to reopen?
- Countries with hopes of relaxing some of the lockdown measures: Germany and Switzerland. Both of them have low case increase rate (~1%) and relatively flat and low death case curve (3 and 5 deaths per day per 1 million population). 
- Countries that probably needs more time: the US and United Kingdom. Although falling, both of them still have about a 5% daily case increase rate. What's more worrying, though, is the evident pressure on the healthcare system. UK sees a drop in daily death cases, but that number is still high at 11; the US's death case curve has not reached its peak yet. 
