...
## 1. Prognosis
- **United States**
    - The number of confirmed cases has been increasing by about 25% daily for a while. This is expected to continue as more testings are carried out([60K test results](#US Testing Numbers) are pending). 
...
- **Europe**
    + The containment efforts are probably taking effect as the number of daily confirmed cases is increasing at a [slower rate every day](#Percentage Change), with Italy, the slowest, at 7.8%, and Spain, the fastest, at 15%. 
    + The Italian healthcare system is still facing a grave challenge, with the case fatality rate (CFR) currently at 11% and still increasing. Spain seems to be heading [in the same direction](#case fatality rate) with a 8.5% CFR. Germany, on the other hand, fares well in this regard and manages to record only a 0.8% fatality rate. Note, though, there are caveats to reporting naive CFR which I explain below. 
- **Asia**
...
- Why Italy has high CFR?
>Italy’s death rate might also be higher because of how fatalities are recorded.  In Italy, all those who die in hospitals with Coronavirus are included in the death counts (association + attribution).

In constrast, Germany only counts the case where the patient dies from Coronavirus (attribution) and not with the Coronavirus (association).
