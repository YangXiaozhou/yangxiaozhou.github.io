...
- **Asia**
    ...
    + India sees a slow down in new confirmed cases with an increasing rate of 12%. Cases in Indonesia is increasing at a moderate speed. However, it has one of the highest CFRs in the region, now at 9%. 
...
- **United States**
    - The increase of new cases continues to slow down [(7%)](#Percentage Change). The US has conducted more than 1.5 million tests over the past ten days, or on average, [150,000 per day](#US Testing Numbers), up from 80,000 per day just one week ago. Still, many states, especially in the mid and mid-west, are lagging on their testing. The daily tests conducted seem to have hit the ceiling and stopped increasing for the past three days.
- **Europe**
    + Countries in Europe have flattened the curve, though, only for the confirmed cases. The death cases are still increasing. 
