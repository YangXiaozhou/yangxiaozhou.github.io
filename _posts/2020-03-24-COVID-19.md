...
## 1. Prognosis
- **Asia**
    + Singapore now has the highest number of COVID-19 cases among ASEAN countries. Dormitory clusters and local unlinked cases continue to drive up the total number (6% increasing rate).
    + Cases in Indonesia is increasing at a moderate speed. However, it has one of the highest CFRs in the region, [now at 8%](#case fatality rate). 
- **United States**
    ...
    - On the other hand, daily new cases continue to slow down [(3%)](#Percentage Change). Still, many states, especially in the mid and mid-west, are lagging on their testing. 
- **Europe**
    ...
    + There are clear signs of recovery as well. The worst-hit countries, Italy, Spain, and the UK are seeing a [stabalization of death rates](#case fatality rate). Meanwhile, UK's CFR now exceeds that of Italy at 16%. 
