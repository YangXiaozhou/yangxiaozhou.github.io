...
tags: 
---
**Any conclusion drawn from the data should be viewed with caution due to the dynamic nature of a pandemic and the adundant sources of bias associated with reporting.** I update every morning the current COVID-19 situation in the US, Europe, and Asia, tracking both the outbreak and any emerging signal of containment. The intent of this blog is not to feed you daily news, but to present underlying trends and perspectives worth considering when you are watching the news. The graphs in this blog are best viewed on a Laptop browser. Latest update: {{ site.time | date: '%B %d, %Y' }}. 

## 1. Prognosis
- **United States**
    - The number of confirmed cases is still inceasing rapidly at a rate of over 20%, although that seems to be slowing down.
    - There is a slight upward trend in the case fatality rate (CFR), likely due to an overwhelmed healthcare system. 
...
- **Europe**
    + The containment efforts are probably taking effect as the number of daily confirmed cases is increasing at a [slower rate every day](#Percentage Change), with Italy, the slowest, at 7%, and Spain, the fastest, at 15%. 
