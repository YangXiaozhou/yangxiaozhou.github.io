...
## 1. Prognosis
- **United States**
    - While it may seem like the increase of new cases is slowing down [(18%)](#Percentage Change), one factor might be because the testing centres have reached their maximum processing capacity. The number of [tests pending results](#US Testing Numbers) hovers around 60,000 for the last seven days. This is [reported by CNN](https://edition.cnn.com/2020/04/01/politics/testing-backlog-coronavirus-quest-invs/index.html) as well.
    - The case fatality rate (CFR) continues to rise, likely due to an increasingly overwhelmed healthcare system. 
...
- **Europe**
    + The containment efforts are taking effect as the number of daily confirmed cases is increasing at a [slower rate every day](#Percentage Change), with Italy, the slowest, at 6%, and Germany, the fastest, at 11%. 
    + The Italian healthcare system is still facing a grave challenge, with the case fatality rate (CFR) currently at 12% and still increasing. Spain seems to be heading [in the same direction](#case fatality rate) with a 9% CFR. 
    + Germany and Switzerland, on the other hand, fare well in this regard and manage to record a 1.3% and 2.8% CFR respectively. These rates are increasing too. Note, though, there are caveats to reporting naive CFR which I explain below. 
- **Asia**
    ...
    + There's been an increasing number of new clusters identified in Singapore over the past few days, bringing the city-state's total to 1059. The government has imposed stricter quarantine procedures and social distancing measures since then.
...
- Italy is seeing hope and approaching the 5% increasing rate, but there's still some days to go to dip under that. Germany, Spain and Switzerland seem to be following suit.
