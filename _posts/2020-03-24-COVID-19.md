---
layout: post
title:  "[Updated Daily] Tracking the COVID-19 Outbreak and Signals of Containment"
...
I update every morning the COVID-19 situation in the US, Europe, and Asia, tracking both the outbreak and signals of containment. The intent of this blog is not to feed daily news, but to present perspectives worth considering when reading the news. The graphs in this blog are interactive and best viewed on a Laptop browser. Latest update: {{ site.time | date: '%B %d, %Y' }}. 


## 1. Prognosis
- **United States**
    - The increase of new cases is slowing down [(13%)](#Percentage Change), as the strategy of "Test! Test! Test!" proves key to knowing the real-time situation on the ground. The US has conducted more than 1.2 million tests over the past ten days, or on average, 120,000 per day. The [number of tests pending results](#US Testing Numbers) also dropped from 61,980 to around 15,000. 
...
- **Europe**
    + The containment efforts are taking effect as the increase of cases has significantly slowed down, with Italy, the slowest, at 4%, and Spain, the fastest, at 8%. 
...
- **Asia**
    + The cases in Japan have been rising at an increasing rate for the past half month, now at a 11% [day-on-day growth rate](#Percentage Change). Considering the exponential growth of infections, Abe, Japanese prime minister, is expected to declare state of emergency for major cities tomorrow (7th April).
