...
## 1. Prognosis
- **Asia**
    + Singapore's dormitory clusters and local unlinked cases continue to drive up the total number. This is expected considering the delay between infection and test confirmation. 
    + Japan has a relatively flat curve. However, there are legitimate concerns that Japan has been under-testing its population. For example, Japan has conducted 437 tests [per one million population](#https://www.worldometers.info/coronavirus/). In Singapore, that number is 11,110. 
- **United States**
    - The increase of new cases is slowing down [(11%)](#Percentage Change). The US has conducted more than 1.3 million tests over the past ten days, or on average, 130,000 per day. The [number of tests pending results](#US Testing Numbers) also dropped from 61,980 to around 16,000. 
    - The case fatality rate (CFR) continues to rise, likely due to an increasingly overwhelmed healthcare system. The number of deaths is going to pass that of Spain.
- **Europe**
    + The containment efforts are taking effect as the increase of cases has significantly slowed down, with Italy, the slowest, at 4%, and UK, the fastest, at 12%. 
    + There are signs of recovery as well. The worst-hit countries in Europe, Italy, and Spain, are seeing a [stabalization of death rates](#case fatality rate). The same cannot be said for the UK, with a CFR of 12% and still increasing. Of course, the UK's advice for citizens with mild symptoms to stay at home for [at least seven days](https://www.businessinsider.sg/coronavirus-boris-johnson-tells-brits-with-symptoms-to-stay-at-home-for-at-least-a-week-2020-3?r=US&IR=T) contributed to the high CFR.   
    + While the CFRs in Switzerland and Germany have been comparatively low, they are steadily climbing. Switzerland is probably the first country in Europe to flatten the curve, which conducted one of the highest number of tests [per one million population](#https://www.worldometers.info/coronavirus/). 
