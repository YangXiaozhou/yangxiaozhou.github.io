...
## 1. Prognosis
- **United States**
    - The increase of new cases is slowing down [(13%)](#Percentage Change), as the strategy of "Test! Test! Test!" proves key to know the real-time situation on the ground. US has conducted more than 1.1 million tests over the past ten days, or on average, 110,000 per day. The [number of tests pending results](#US Testing Numbers) also dropped from 61,980 to around 15,000. 
...
- **Europe**
    + The containment efforts are taking effect as the number of cases is increasing at a [slower rate every day](#Percentage Change), with Italy, the slowest, at 4%, and Spain, the fastest, at 8%. 
    + The Italian healthcare system is still facing a grave challenge, with the case fatality rate (CFR) currently at 12%. Spain seems to be heading [in the same direction](#case fatality rate) with a 10% CFR. However, there are signs that the CFRs are slowing down.
    + Germany and Switzerland, on the other hand, fare well in this regard and manage to record a 1.6% and 3.4% CFR, respectively. Austria, too, has managed one of the lowerest CFRs (1.4%) among European nations. (Austria, Germany, and a large part of Switzerland are all German-speaking.🤔) Note there are caveats to reporting naive CFR which I [explain below](case fatality rate). 
- **Asia**
    + The cases in Japan have been rising at an increasing rate for the past half month, now at a 11% [day-on-day growth rate](#Percentage Change). Considering the exponential growth of infections, Abe, Japanese prime minister, is expected to declare national state of emergency tomorrow (7th April).
    + Singapore is seeing record number of confirmed cases over the past few days, which underscores the governmnent's decision to introduce the circuit breaker, Singapore's version of "Shelter in Place", starting from Tuesday this week. We will see if the most drastic measure implemented so far could prevent a wide-spread community infection in Singapore over the next few weeks.  
...
#### Past updates
  + We could almost cerntainly say that Japan is undertesting its population to know what is really going on. Assuming the true CFR is 1.2%[^diamond_princess], Japan's current fatality number, 77, indicates that at least 6,417 people have been infected. However, only 3,139 cases are officially confirmed as of now. - 5th April.
  + For the first time, Singapore is going into a national "Shelter in Place" mode. The timeing is not surprising as some degree of wide-spread community infection is going on. The number of unlinked cases, those yet to find the source of infection, spiked over the last few days; Singapore also recorded 12 new clusters of infection just over the past five days (One of them is right across the river from my house). - 5th April.
