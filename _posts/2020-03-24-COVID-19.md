...
- **Europe**
    ...
    + The Italian healthcare system is still facing a grave challenge, with the case fatality rate currently at 11% and still increasing. Spain seems to be heading [in the same direction](#case fatality rate) with a 8.5% fatality rate. Germany, though, fares well in this regard and manages to record only a 0.8% fatality rate. Note, though, there are caveats to naive case fatality rates which I explain below. 
- **Asia**
...
- Why Italy has high case fatality rate (CFR)?
...
- Effect of strategy and selection bias on data reported
...
**CFR is probably inflated in many countries. IFR is much lower than CFR.**
