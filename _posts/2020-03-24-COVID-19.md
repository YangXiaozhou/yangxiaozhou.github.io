...
I update the current COVID-19 situation in the US, Europe, and Asia, tracking both the outbreak and any emerging signals of containment. Latest update: {{ site.time | date: '%B %d, %Y' }}. The graphs in this blog are best viewed on a Laptop browser. 
