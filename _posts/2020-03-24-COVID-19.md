...
## 1. Prognosis
- **Asia**
    + Singapore's dormitory clusters and local unlinked cases continue to drive up the total number (12% increasing rate). This is expected considering the delay between infection and test confirmation. The government has also stepped up social distancing measures, particularly in the enforcement front. Warnings, fines, and the revoking of passes are as active as the people exercising in public parks on the past Sunday morning. 
    + India sees a slow down in new confirmed cases with an increasing rate of 11%. Cases in Indonesia is increasing at a moderate speed. However, it has one of the highest CFRs in the region, [now at 9%](#case fatality rate). 
