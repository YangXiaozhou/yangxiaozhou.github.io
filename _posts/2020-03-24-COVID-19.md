...
- **Asia**
    + The cases in Japan have been rising at an increasing rate for the past half month, now at 11% [day-on-day growth rate](#Percentage Change). Considering the exponential growth of infections, Abe, Japanese prime minister, is expected to declare national state of emergency tomorrow (7th April).
