...
## 1. Prognosis
- **United States**
    - While it may seem like the increase of new cases is slowing down [(19%)](#Percentage Change), one factor might be because the testing centres have reached their maximum processing capacity. The number of [tests pending results](#US Testing Numbers) hovers around 60,000 for the last seven days. This is [reported by CNN](https://edition.cnn.com/2020/04/01/politics/testing-backlog-coronavirus-quest-invs/index.html) today.
...
- **Europe**
    + The containment efforts are taking effect as the number of daily confirmed cases is increasing at a [slower rate every day](#Percentage Change), with Italy, the slowest, at 6%, and Spain, the fastest, at 13%. 
    ...
    + Germany and Switzerland, on the other hand, fare well in this regard and manage to record a 1.2% and 2.7% CFR respectively. These rates are increasing too. Note, though, there are caveats to reporting naive CFR which I explain below. 
- **Asia**
