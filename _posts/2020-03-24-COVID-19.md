...
## 1. Prognosis
- **Asia**
    + Singapore's dormitory clusters and local unlinked cases continue to drive up the total number (13% increasing rate). This is expected considering the delay between infection and test confirmation. The government has also stepped up social distancing measures, particularly in the enforcement front. Warnings, fines, and the revoking of passes are as active as the people exercising in public parks on the past Sunday morning. 
    + India sees a slow down in new confirmed cases with an increasing rate of 10%. Cases in Indonesia is increasing at a moderate speed. However, it has one of the highest CFRs in the region, [now at 9%](#case fatality rate). 
...
- **United States**
    + We are seeing a spike in the number of death cases and an increase in the CFR, now at 5%. This is likely due to the overwhelmed healthcare system. 
    - The increase of new cases continues to slow down [(6%)](#Percentage Change). The US has conducted more than 1.5 million tests over the past ten days, or on average, 150,000 per day. Still, many states, especially in the mid and mid-west, are lagging on their testing. The daily tests conducted seem to have [hit the ceiling](#US Testing Numbers).
- **Europe**
