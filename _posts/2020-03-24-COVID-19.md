...
I update (almost) every morning the COVID-19 situation in the US, Europe, and Asia, tracking both the outbreak and signals of containment. The intent of this blog is not to feed daily news, but to present perspectives worth considering when reading the news. The graphs in this blog are **interactive** and best viewed on a Laptop browser. Latest update: {{ site.time | date: '%B %d, %Y' }}. 


## 1. Prognosis
- **Asia**
    + Singapore now has the highest number of COVID-19 cases among ASEAN countries. Dormitory clusters and local unlinked cases continue to drive up the total number (15% increasing rate).
    + Japan continues to see a slowdown of daily new cases. It's been two weeks since the first declaration of "Emergency Situation" by the prime minister. On average, a 50% reduction in the number of people going out in monitored areas [are observed](https://www3.nhk.or.jp/news/special/coronavirus/#infection-status). Meanwhile, mask sales have skyrocketed in Japan. 
    + Cases in Indonesia is increasing at a moderate speed. However, it has one of the highest CFRs in the region, [now at 9%](#case fatality rate). 
    + Overall, the picture looks grim for Asian countries where some are fighting a second wave while others are still in their first battle.
- **United States**
    + Death toll continues to rise, and the CFR is now at 6%. As more cases surface, the healthcare system faces increasing pressure to provide limited ICU beds to the most needed. 
    - On the other hand, daily new cases continue to slow down [(4%)](#Percentage Change). Still, many states, especially in the mid and mid-west, are lagging on their testing. The daily tests conducted seem to have [hit the ceiling](#US Testing Numbers). That number was around 150,000 per day, and it plateaued out for the past 15 days. Underutilized test capacity points to a [lack of national strategy](#https://www.nature.com/articles/d41586-020-01068-3), rather than an unsolvable technology challenge. 
- **Europe**
    + Countries in Europe have [flattened the curve](#Case progression), though, only for the confirmed cases. The death cases are still increasing. 
    + There are clear signs of recovery as well. The worst-hit countries, Italy, Spain, and the UK are seeing a [stabalization of death rates](#case fatality rate). Meanwhile, UK's CFR now exceeds that of Italy at 13%. 
    + Overall, European countries may be approaching their peak in confirmed cases, and the stabilization of CFR indicates the rebound of the healthcare system. However, as we saw the recent surges in places like Singapore and South Korea, this is a long battle, and the second wave may arrive at any instance of complacency. 
    + Note there are caveats to reporting naive CFR (the ratio of current death and current cases), which I [explain below](#cfr bias). 
...
When should the economy reopen? To try to answer this question, we could look at the interplay of new confirmed cases and death cases. More cases means more healthcare resource demand, and doctors and nurses have to make tough decisions. Unfortunately, more patients who need intensive care might not get it, leading to higher fatalities. We are probably going to see a peak in case increase, and after some time, a peak in daily fatalities. This phenomenon is visible in the graph below. Passing the first peak means measures are taking effect; passing the second means our healthcare system is now able to cope. So, where do countries stand as of now?
<iframe width="696" height="432" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQnqDux0h60qbKyhlYff1YMpjwhPZA694IOW4ixe0XNFi-JUHjXxJ69AFIGXajrBURwUKW2FnELgE1C/pubchart?oid=196899578&amp;format=interactive"></iframe>
...
- Countries with hopes of relaxing some of the lockdown measures: Germany and Switzerland. Both of them have passed the peaks, have a low case increase rate (~1%), and relatively flat and low death case curve (3 and 5 deaths per day per 1 million population). 
- Countries that probably need more time: the US and the UK. They have just passed the first peak. They still records about a 5% daily case increase rate. What's more worrying, though, is the evident pressure on the healthcare system. UK sees a drop in daily death cases, but that number is still high at 11; the US's death case curve has not reached its peak yet. - April 23, 2020 
