...
## 1. Prognosis
- **United States**
    - The increase of new cases is slowing down [(18%)](#Percentage Change). One factor might be because the testing centres have reached their maximum processing capacity as the number of [tests pending results](#US Testing Numbers) hovers around 60,000 for the last nine days. This is [reported by CNN](https://edition.cnn.com/2020/04/01/politics/testing-backlog-coronavirus-quest-invs/index.html), too.
...
- **Europe**
    + The containment efforts are taking effect as the number of cases is increasing at a [slower rate every day](#Percentage Change), with Italy, the slowest, at 5%, and Germany, the fastest, at 10%. 
    + The Italian healthcare system is still facing a grave challenge, with the case fatality rate (CFR) currently at 12% and still increasing. Spain seems to be heading [in the same direction](#case fatality rate) with a 9% CFR. France, not tracked here, is on par with Spain in CFR. 
...
- **Asia**
    ...
    + Japan seems to have steadied the rate of infection, partly thanks to the public plea by the governor of Tokyo, Yuriko Koike (小池百合子), and her [hint on a possible Tokyo lockdown](http://www.asahi.com/ajw/articles/13240195).
