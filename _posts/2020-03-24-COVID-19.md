...
### 1. Percentage Change
5-day moving average (MA) of the percentage change in confirmed cases reported in selected countries. To easily classify the situation, we can use the following scale[^percentage]:
