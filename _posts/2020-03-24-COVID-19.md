...
## 1. Prognosis
- **Asia**
    + Singapore's dormitory clusters and local unlinked cases continue to drive up the total number (10% increasing rate). This is expected considering the delay between infection and test confirmation. 
